...
public class MenuManager implements Menu {
    ...
    private void addClothingItem() {
        ...
        try {
            ...
            item = new Pants(id, name, size, price, brand, stock, ft, waist, inseam, material);
                ...
                // ClothingItem is abstract in Week 6.
                // For "generic" items we create an anonymous subclass.
    ...
    private void addItemToOrder() {
        ...
        try {
            ...
            if (ok) {
                ...
                System.out.println("Failed to add item: not enough stock.");
            }
        } catch (RuntimeException e) {
            System.out.println("Failed to add item: " + e.getMessage());
        }
    ...
    private void completeOrder() {
        ...
        try {
            ...
            System.out.println("Cannot complete order: " + e.getMessage());
        }
    }
    ...
    private void cancelOrder() {
        ...
        try {
            ...
            System.out.println("Cannot cancel order: " + e.getMessage());
        }
    }
